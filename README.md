...
The VRPayment C# SDK is used to interact with VRPayment's REST API.
...
#### Package Manager
```shell
Install-Package VRPayment -Version 1.0.0
```
#### .NET CLI
```shell
dotnet add package VRPayment --version 1.0.0
```
#### Paket CLI
```shell
paket add VRPayment --version 1.0.0
```
#### PackageReference
```
<PackageReference Include="VRPayment" Version="1.0.0" />
```
...
While working with webhooks, the `VRPaymentSdkException` may throw various error codes to help identify and troubleshoot issues.
...
Please see the [license file](https://github.com/vr-payment/csharp-sdk/blob/master/LICENSE) for more information.
