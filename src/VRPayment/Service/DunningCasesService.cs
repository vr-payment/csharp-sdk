...
namespace VRPayment.Service
{
    ...
    public partial class DunningCasesService : IDunningCasesService
    {
        ...
        /// <returns></returns>
        public DunningCasesService(VRPayment.Client.Configuration configuration)
        {
        ...
        public DunningCasesService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        {
            VRPayment.Client.ApiResponse<DunningCaseListResponse> localVarResponse = GetPaymentDunningCasesWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DunningCaseListResponse</returns>
        public VRPayment.Client.ApiResponse<DunningCaseListResponse> GetPaymentDunningCasesWithHttpInfo(long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<DunningCase> localVarResponse = GetPaymentDunningCasesIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DunningCase</returns>
        public VRPayment.Client.ApiResponse<DunningCase> GetPaymentDunningCasesIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<DunningCaseSearchResponse> localVarResponse = GetPaymentDunningCasesSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DunningCaseSearchResponse</returns>
        public VRPayment.Client.ApiResponse<DunningCaseSearchResponse> GetPaymentDunningCasesSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> PostPaymentDunningCasesIdSuspendWithHttpInfo(long id, long space, DateTime? plannedEndDate = default(DateTime?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
            ...
            {
                localVarRequestOptions.QueryParameters.Add(VRPayment.Client.ClientUtils.ParameterToMultiMap("", "plannedEndDate", plannedEndDate));
            }
            localVarRequestOptions.HeaderParameters.Add("Space", VRPayment.Client.ClientUtils.ParameterToString(space)); // header parameter
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> PostPaymentDunningCasesInvoiceInvoiceIdWithHttpInfo(long invoiceId, long space, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
