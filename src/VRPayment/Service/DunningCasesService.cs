...
namespace VRPayment.Service
{
    ...
    public partial class DunningCasesService : IDunningCasesService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DunningCaseListResponse</returns>
        public VRPayment.Client.ApiResponse<DunningCaseListResponse> GetPaymentDunningCasesWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DunningCase</returns>
        public VRPayment.Client.ApiResponse<DunningCase> GetPaymentDunningCasesIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DunningCaseSearchResponse</returns>
        public VRPayment.Client.ApiResponse<DunningCaseSearchResponse> GetPaymentDunningCasesSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> PostPaymentDunningCasesIdSuspendWithHttpInfo(long id, long space, DateTime? plannedEndDate = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
