...
namespace VRPayment.Service
{
    ...
    public partial class CustomerCommentsService : ICustomerCommentsService
    {
        ...
        /// <returns></returns>
        public CustomerCommentsService(VRPayment.Client.Configuration configuration)
        {
        ...
        public CustomerCommentsService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> DeleteCustomersCustomerIdCommentsIdWithHttpInfo(long customerId, long id, long space, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.PathParameters.Add("customerId", VRPayment.Client.ClientUtils.ParameterToString(customerId)); // path parameter
        ...
        {
            VRPayment.Client.ApiResponse<CustomerCommentListResponse> localVarResponse = GetCustomersCustomerIdCommentsWithHttpInfo(customerId, space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerCommentListResponse</returns>
        public VRPayment.Client.ApiResponse<CustomerCommentListResponse> GetCustomersCustomerIdCommentsWithHttpInfo(long customerId, long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<CustomerComment> localVarResponse = GetCustomersCustomerIdCommentsIdWithHttpInfo(customerId, id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerComment</returns>
        public VRPayment.Client.ApiResponse<CustomerComment> GetCustomersCustomerIdCommentsIdWithHttpInfo(long customerId, long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<CustomerCommentSearchResponse> localVarResponse = GetCustomersCustomerIdCommentsSearchWithHttpInfo(customerId, space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerCommentSearchResponse</returns>
        public VRPayment.Client.ApiResponse<CustomerCommentSearchResponse> GetCustomersCustomerIdCommentsSearchWithHttpInfo(long customerId, long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<CustomerComment> localVarResponse = PatchCustomersCustomerIdCommentsIdWithHttpInfo(customerId, id, space, customerCommentActive, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerComment</returns>
        public VRPayment.Client.ApiResponse<CustomerComment> PatchCustomersCustomerIdCommentsIdWithHttpInfo(long customerId, long id, long space, CustomerCommentActive customerCommentActive, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'customerCommentActive' is set
            if (customerCommentActive == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'customerCommentActive' when calling CustomerCommentsService->PatchCustomersCustomerIdCommentsId");
            }
        ...
        {
            VRPayment.Client.ApiResponse<CustomerComment> localVarResponse = PostCustomersCustomerIdCommentsWithHttpInfo(customerId, space, customerCommentCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerComment</returns>
        public VRPayment.Client.ApiResponse<CustomerComment> PostCustomersCustomerIdCommentsWithHttpInfo(long customerId, long space, CustomerCommentCreate customerCommentCreate, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'customerCommentCreate' is set
            if (customerCommentCreate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'customerCommentCreate' when calling CustomerCommentsService->PostCustomersCustomerIdComments");
            }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> PostCustomersCustomerIdCommentsIdPinWithHttpInfo(long customerId, long id, long space, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> PostCustomersCustomerIdCommentsIdUnpinWithHttpInfo(long customerId, long id, long space, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
