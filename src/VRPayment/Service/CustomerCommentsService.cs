...
namespace VRPayment.Service
{
    ...
    public partial class CustomerCommentsService : ICustomerCommentsService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerCommentListResponse</returns>
        public VRPayment.Client.ApiResponse<CustomerCommentListResponse> GetCustomersCustomerIdCommentsWithHttpInfo(long customerId, long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerComment</returns>
        public VRPayment.Client.ApiResponse<CustomerComment> GetCustomersCustomerIdCommentsIdWithHttpInfo(long customerId, long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerComment</returns>
        public VRPayment.Client.ApiResponse<CustomerComment> PatchCustomersCustomerIdCommentsIdWithHttpInfo(long customerId, long id, long space, CustomerCommentActive customerCommentActive, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerComment</returns>
        public VRPayment.Client.ApiResponse<CustomerComment> PostCustomersCustomerIdCommentsWithHttpInfo(long customerId, long space, CustomerCommentCreate customerCommentCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
