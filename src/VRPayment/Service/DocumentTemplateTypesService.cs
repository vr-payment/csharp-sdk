...
namespace VRPayment.Service
{
    ...
    public partial class DocumentTemplateTypesService : IDocumentTemplateTypesService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DocumentTemplateTypeListResponse</returns>
        public VRPayment.Client.ApiResponse<DocumentTemplateTypeListResponse> GetDocumentTemplatesTypesWithHttpInfo(long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DocumentTemplateType</returns>
        public VRPayment.Client.ApiResponse<DocumentTemplateType> GetDocumentTemplatesTypesIdWithHttpInfo(long id, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DocumentTemplateTypeSearchResponse</returns>
        public VRPayment.Client.ApiResponse<DocumentTemplateTypeSearchResponse> GetDocumentTemplatesTypesSearchWithHttpInfo(List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
