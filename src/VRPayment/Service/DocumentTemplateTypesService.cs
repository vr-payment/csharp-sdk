...
namespace VRPayment.Service
{
    ...
    public partial class DocumentTemplateTypesService : IDocumentTemplateTypesService
    {
        ...
        /// <returns></returns>
        public DocumentTemplateTypesService(VRPayment.Client.Configuration configuration)
        {
        ...
        public DocumentTemplateTypesService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        {
            VRPayment.Client.ApiResponse<DocumentTemplateTypeListResponse> localVarResponse = GetDocumentTemplatesTypesWithHttpInfo(after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DocumentTemplateTypeListResponse</returns>
        public VRPayment.Client.ApiResponse<DocumentTemplateTypeListResponse> GetDocumentTemplatesTypesWithHttpInfo(long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<DocumentTemplateType> localVarResponse = GetDocumentTemplatesTypesIdWithHttpInfo(id, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DocumentTemplateType</returns>
        public VRPayment.Client.ApiResponse<DocumentTemplateType> GetDocumentTemplatesTypesIdWithHttpInfo(long id, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<DocumentTemplateTypeSearchResponse> localVarResponse = GetDocumentTemplatesTypesSearchWithHttpInfo(expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DocumentTemplateTypeSearchResponse</returns>
        public VRPayment.Client.ApiResponse<DocumentTemplateTypeSearchResponse> GetDocumentTemplatesTypesSearchWithHttpInfo(List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
