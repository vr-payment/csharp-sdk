...
namespace VRPayment.Service
{
    ...
    public partial class SubscriptionProductMeteredFeesService : ISubscriptionProductMeteredFeesService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductMeteredFeeListResponse</returns>
        public VRPayment.Client.ApiResponse<ProductMeteredFeeListResponse> GetSubscriptionsProductsMeteredFeesWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductMeteredFee</returns>
        public VRPayment.Client.ApiResponse<ProductMeteredFee> GetSubscriptionsProductsMeteredFeesIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductMeteredFeeSearchResponse</returns>
        public VRPayment.Client.ApiResponse<ProductMeteredFeeSearchResponse> GetSubscriptionsProductsMeteredFeesSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductMeteredFee</returns>
        public VRPayment.Client.ApiResponse<ProductMeteredFee> PatchSubscriptionsProductsMeteredFeesIdWithHttpInfo(long id, long space, ProductMeteredFeeUpdate productMeteredFeeUpdate, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductMeteredFee</returns>
        public VRPayment.Client.ApiResponse<ProductMeteredFee> PostSubscriptionsProductsMeteredFeesWithHttpInfo(long space, ProductMeteredFeeUpdate productMeteredFeeUpdate, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'productMeteredFeeUpdate' is set
            if (productMeteredFeeUpdate == null)
            {
