...
namespace VRPayment.Service
{
    ...
    public partial class WebhookListenersService : IWebhookListenersService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of WebhookListenerListResponse</returns>
        public VRPayment.Client.ApiResponse<WebhookListenerListResponse> GetWebhooksListenersWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of WebhookListener</returns>
        public VRPayment.Client.ApiResponse<WebhookListener> GetWebhooksListenersIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of WebhookListenerSearchResponse</returns>
        public VRPayment.Client.ApiResponse<WebhookListenerSearchResponse> GetWebhooksListenersSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of WebhookListener</returns>
        public VRPayment.Client.ApiResponse<WebhookListener> PatchWebhooksListenersIdWithHttpInfo(long id, long space, WebhookListenerUpdate webhookListenerUpdate, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'webhookListenerUpdate' is set
            if (webhookListenerUpdate == null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of WebhookListener</returns>
        public VRPayment.Client.ApiResponse<WebhookListener> PostWebhooksListenersWithHttpInfo(long space, WebhookListenerCreate webhookListenerCreate, List<string>? expand = default, int operationIndex = 0)
        {
