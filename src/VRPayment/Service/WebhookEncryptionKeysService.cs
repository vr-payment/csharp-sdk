...
namespace VRPayment.Service
{
    ...
    public partial class WebhookEncryptionKeysService : IWebhookEncryptionKeysService
    {
        ...
        /// <returns></returns>
        public WebhookEncryptionKeysService(VRPayment.Client.Configuration configuration)
        {
        ...
        public WebhookEncryptionKeysService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        {
            VRPayment.Client.ApiResponse<string> localVarResponse = GetWebhooksEncryptionKeysIdWithHttpInfo(id);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of string</returns>
        public VRPayment.Client.ApiResponse<string> GetWebhooksEncryptionKeysIdWithHttpInfo(string id, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'id' when calling WebhookEncryptionKeysService->GetWebhooksEncryptionKeysId");
            }
            ...
            /// </summary>
            /// <exception cref="VRPayment.Client.VRPaymentSdkException">Thrown when validation fails or public key is not found.</exception>
