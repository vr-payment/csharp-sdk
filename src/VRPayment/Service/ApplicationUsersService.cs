...
namespace VRPayment.Service
{
    ...
    public partial class ApplicationUsersService : IApplicationUsersService
    {
        ...
        /// <returns></returns>
        public ApplicationUsersService(VRPayment.Client.Configuration configuration)
        {
        ...
        public ApplicationUsersService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> DeleteApplicationUsersIdWithHttpInfo(long id, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> DeleteApplicationUsersUserIdKeysIdWithHttpInfo(long userId, long id, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<ApplicationUserListResponse> localVarResponse = GetApplicationUsersWithHttpInfo(after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApplicationUserListResponse</returns>
        public VRPayment.Client.ApiResponse<ApplicationUserListResponse> GetApplicationUsersWithHttpInfo(long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<ApplicationUser> localVarResponse = GetApplicationUsersIdWithHttpInfo(id, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApplicationUser</returns>
        public VRPayment.Client.ApiResponse<ApplicationUser> GetApplicationUsersIdWithHttpInfo(long id, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<ApplicationUserSearchResponse> localVarResponse = GetApplicationUsersSearchWithHttpInfo(expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApplicationUserSearchResponse</returns>
        public VRPayment.Client.ApiResponse<ApplicationUserSearchResponse> GetApplicationUsersSearchWithHttpInfo(List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<List<RestApplicationUserMacKey>> localVarResponse = GetApplicationUsersUserIdKeysWithHttpInfo(userId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;RestApplicationUserMacKey&gt;</returns>
        public VRPayment.Client.ApiResponse<List<RestApplicationUserMacKey>> GetApplicationUsersUserIdKeysWithHttpInfo(long userId, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<ApplicationUser> localVarResponse = PatchApplicationUsersIdWithHttpInfo(id, applicationUserUpdate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApplicationUser</returns>
        public VRPayment.Client.ApiResponse<ApplicationUser> PatchApplicationUsersIdWithHttpInfo(long id, ApplicationUserUpdate applicationUserUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'applicationUserUpdate' is set
            if (applicationUserUpdate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'applicationUserUpdate' when calling ApplicationUsersService->PatchApplicationUsersId");
            }
        ...
        {
            VRPayment.Client.ApiResponse<ApplicationUserCreateWithMacKey> localVarResponse = PostApplicationUsersWithHttpInfo(applicationUserCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApplicationUserCreateWithMacKey</returns>
        public VRPayment.Client.ApiResponse<ApplicationUserCreateWithMacKey> PostApplicationUsersWithHttpInfo(ApplicationUserCreate applicationUserCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'applicationUserCreate' is set
            if (applicationUserCreate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'applicationUserCreate' when calling ApplicationUsersService->PostApplicationUsers");
            }
        ...
        {
            VRPayment.Client.ApiResponse<RestApplicationUserMacKeyCreated> localVarResponse = PostApplicationUsersUserIdKeysWithHttpInfo(userId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RestApplicationUserMacKeyCreated</returns>
        public VRPayment.Client.ApiResponse<RestApplicationUserMacKeyCreated> PostApplicationUsersUserIdKeysWithHttpInfo(long userId, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
