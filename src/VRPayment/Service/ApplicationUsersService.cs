...
namespace VRPayment.Service
{
    ...
    public partial class ApplicationUsersService : IApplicationUsersService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApplicationUserListResponse</returns>
        public VRPayment.Client.ApiResponse<ApplicationUserListResponse> GetApplicationUsersWithHttpInfo(long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApplicationUser</returns>
        public VRPayment.Client.ApiResponse<ApplicationUser> GetApplicationUsersIdWithHttpInfo(long id, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApplicationUserSearchResponse</returns>
        public VRPayment.Client.ApiResponse<ApplicationUserSearchResponse> GetApplicationUsersSearchWithHttpInfo(List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApplicationUser</returns>
        public VRPayment.Client.ApiResponse<ApplicationUser> PatchApplicationUsersIdWithHttpInfo(long id, ApplicationUserUpdate applicationUserUpdate, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApplicationUserCreateWithMacKey</returns>
        public VRPayment.Client.ApiResponse<ApplicationUserCreateWithMacKey> PostApplicationUsersWithHttpInfo(ApplicationUserCreate applicationUserCreate, List<string>? expand = default, int operationIndex = 0)
        {
