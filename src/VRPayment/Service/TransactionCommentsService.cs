...
namespace VRPayment.Service
{
    ...
    public partial class TransactionCommentsService : ITransactionCommentsService
    {
        ...
        /// <returns></returns>
        public TransactionCommentsService(VRPayment.Client.Configuration configuration)
        {
        ...
        public TransactionCommentsService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> DeletePaymentTransactionsTransactionIdCommentsIdWithHttpInfo(long transactionId, long id, long space, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.PathParameters.Add("transactionId", VRPayment.Client.ClientUtils.ParameterToString(transactionId)); // path parameter
        ...
        {
            VRPayment.Client.ApiResponse<TransactionCommentListResponse> localVarResponse = GetPaymentTransactionsTransactionIdCommentsWithHttpInfo(transactionId, space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionCommentListResponse</returns>
        public VRPayment.Client.ApiResponse<TransactionCommentListResponse> GetPaymentTransactionsTransactionIdCommentsWithHttpInfo(long transactionId, long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<TransactionComment> localVarResponse = GetPaymentTransactionsTransactionIdCommentsIdWithHttpInfo(transactionId, id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionComment</returns>
        public VRPayment.Client.ApiResponse<TransactionComment> GetPaymentTransactionsTransactionIdCommentsIdWithHttpInfo(long transactionId, long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<TransactionCommentSearchResponse> localVarResponse = GetPaymentTransactionsTransactionIdCommentsSearchWithHttpInfo(transactionId, space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionCommentSearchResponse</returns>
        public VRPayment.Client.ApiResponse<TransactionCommentSearchResponse> GetPaymentTransactionsTransactionIdCommentsSearchWithHttpInfo(long transactionId, long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<TransactionComment> localVarResponse = PatchPaymentTransactionsTransactionIdCommentsIdWithHttpInfo(transactionId, id, space, transactionCommentActive, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionComment</returns>
        public VRPayment.Client.ApiResponse<TransactionComment> PatchPaymentTransactionsTransactionIdCommentsIdWithHttpInfo(long transactionId, long id, long space, TransactionCommentActive transactionCommentActive, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'transactionCommentActive' is set
            if (transactionCommentActive == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'transactionCommentActive' when calling TransactionCommentsService->PatchPaymentTransactionsTransactionIdCommentsId");
            }
        ...
        {
            VRPayment.Client.ApiResponse<TransactionComment> localVarResponse = PostPaymentTransactionsTransactionIdCommentsWithHttpInfo(transactionId, space, transactionCommentCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionComment</returns>
        public VRPayment.Client.ApiResponse<TransactionComment> PostPaymentTransactionsTransactionIdCommentsWithHttpInfo(long transactionId, long space, TransactionCommentCreate transactionCommentCreate, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'transactionCommentCreate' is set
            if (transactionCommentCreate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'transactionCommentCreate' when calling TransactionCommentsService->PostPaymentTransactionsTransactionIdComments");
            }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> PostPaymentTransactionsTransactionIdCommentsIdPinWithHttpInfo(long transactionId, long id, long space, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> PostPaymentTransactionsTransactionIdCommentsIdUnpinWithHttpInfo(long transactionId, long id, long space, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
