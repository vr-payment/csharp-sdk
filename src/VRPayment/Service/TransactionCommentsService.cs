...
namespace VRPayment.Service
{
    ...
    public partial class TransactionCommentsService : ITransactionCommentsService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionComment</returns>
        public VRPayment.Client.ApiResponse<TransactionComment> GetPaymentTransactionsTransactionIdCommentsIdWithHttpInfo(long transactionId, long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionComment</returns>
        public VRPayment.Client.ApiResponse<TransactionComment> PatchPaymentTransactionsTransactionIdCommentsIdWithHttpInfo(long transactionId, long id, long space, TransactionCommentActive transactionCommentActive, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionComment</returns>
        public VRPayment.Client.ApiResponse<TransactionComment> PostPaymentTransactionsTransactionIdCommentsWithHttpInfo(long transactionId, long space, TransactionCommentCreate transactionCommentCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
