...
namespace VRPayment.Service
{
    ...
    public partial class TransactionLineItemVersionsService : ITransactionLineItemVersionsService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LineItemVersionListResponse</returns>
        public VRPayment.Client.ApiResponse<LineItemVersionListResponse> GetPaymentTransactionsLineItemVersionsWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionLineItemVersion</returns>
        public VRPayment.Client.ApiResponse<TransactionLineItemVersion> GetPaymentTransactionsLineItemVersionsIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LineItemVersionSearchResponse</returns>
        public VRPayment.Client.ApiResponse<LineItemVersionSearchResponse> GetPaymentTransactionsLineItemVersionsSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionLineItemVersion</returns>
        public VRPayment.Client.ApiResponse<TransactionLineItemVersion> PostPaymentTransactionsLineItemVersionsWithHttpInfo(long space, TransactionLineItemVersionCreate transactionLineItemVersionCreate, List<string>? expand = default, int operationIndex = 0)
        {
