...
namespace VRPayment.Service
{
    ...
    public partial class TransactionLineItemVersionsService : ITransactionLineItemVersionsService
    {
        ...
        /// <returns></returns>
        public TransactionLineItemVersionsService(VRPayment.Client.Configuration configuration)
        {
        ...
        public TransactionLineItemVersionsService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        {
            VRPayment.Client.ApiResponse<LineItemVersionListResponse> localVarResponse = GetPaymentTransactionsLineItemVersionsWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LineItemVersionListResponse</returns>
        public VRPayment.Client.ApiResponse<LineItemVersionListResponse> GetPaymentTransactionsLineItemVersionsWithHttpInfo(long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<TransactionLineItemVersion> localVarResponse = GetPaymentTransactionsLineItemVersionsIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionLineItemVersion</returns>
        public VRPayment.Client.ApiResponse<TransactionLineItemVersion> GetPaymentTransactionsLineItemVersionsIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<LineItemVersionSearchResponse> localVarResponse = GetPaymentTransactionsLineItemVersionsSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LineItemVersionSearchResponse</returns>
        public VRPayment.Client.ApiResponse<LineItemVersionSearchResponse> GetPaymentTransactionsLineItemVersionsSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<TransactionLineItemVersion> localVarResponse = PostPaymentTransactionsLineItemVersionsWithHttpInfo(space, transactionLineItemVersionCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionLineItemVersion</returns>
        public VRPayment.Client.ApiResponse<TransactionLineItemVersion> PostPaymentTransactionsLineItemVersionsWithHttpInfo(long space, TransactionLineItemVersionCreate transactionLineItemVersionCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'transactionLineItemVersionCreate' is set
            if (transactionLineItemVersionCreate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'transactionLineItemVersionCreate' when calling TransactionLineItemVersionsService->PostPaymentTransactionsLineItemVersions");
            }
