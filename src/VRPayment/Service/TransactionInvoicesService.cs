...
namespace VRPayment.Service
{
    ...
    public partial class TransactionInvoicesService : ITransactionInvoicesService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of InvoiceListResponse</returns>
        public VRPayment.Client.ApiResponse<InvoiceListResponse> GetPaymentTransactionsInvoicesWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionInvoice</returns>
        public VRPayment.Client.ApiResponse<TransactionInvoice> GetPaymentTransactionsInvoicesIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of InvoiceSearchResponse</returns>
        public VRPayment.Client.ApiResponse<InvoiceSearchResponse> GetPaymentTransactionsInvoicesSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionInvoice</returns>
        public VRPayment.Client.ApiResponse<TransactionInvoice> PostPaymentTransactionsInvoicesIdDerecognizeWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionInvoice</returns>
        public VRPayment.Client.ApiResponse<TransactionInvoice> PostPaymentTransactionsInvoicesIdMarkPaidWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionInvoice</returns>
        public VRPayment.Client.ApiResponse<TransactionInvoice> PostPaymentTransactionsInvoicesIdReplaceWithHttpInfo(long id, long space, TransactionInvoiceReplacement transactionInvoiceReplacement, List<string>? expand = default, int operationIndex = 0)
        {
