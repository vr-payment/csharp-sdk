...
namespace VRPayment.Service
{
    ...
    public partial class BogusExpressCheckoutService : IBogusExpressCheckoutService
    {
        ...
        /// <returns></returns>
        public BogusExpressCheckoutService(VRPayment.Client.Configuration configuration)
        {
        ...
        public BogusExpressCheckoutService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        {
            VRPayment.Client.ApiResponse<ExpressCheckoutApprovalResponse> localVarResponse = PostBogusExpressCheckoutOnApproveWithHttpInfo(sessionToken, space, bogusExpressCheckoutApprovalRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ExpressCheckoutApprovalResponse</returns>
        public VRPayment.Client.ApiResponse<ExpressCheckoutApprovalResponse> PostBogusExpressCheckoutOnApproveWithHttpInfo(string sessionToken, long space, BogusExpressCheckoutApprovalRequest bogusExpressCheckoutApprovalRequest, int operationIndex = 0)
        {
            // verify the required parameter 'sessionToken' is set
            if (sessionToken == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'sessionToken' when calling BogusExpressCheckoutService->PostBogusExpressCheckoutOnApprove");
            }

            // verify the required parameter 'bogusExpressCheckoutApprovalRequest' is set
            if (bogusExpressCheckoutApprovalRequest == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'bogusExpressCheckoutApprovalRequest' when calling BogusExpressCheckoutService->PostBogusExpressCheckoutOnApprove");
            }
