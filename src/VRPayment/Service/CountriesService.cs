...
namespace VRPayment.Service
{
    ...
    public partial class CountriesService : ICountriesService
    {
        ...
        /// <returns></returns>
        public CountriesService(VRPayment.Client.Configuration configuration)
        {
        ...
        public CountriesService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        {
            VRPayment.Client.ApiResponse<CountryListResponse> localVarResponse = GetCountriesWithHttpInfo(expand);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CountryListResponse</returns>
        public VRPayment.Client.ApiResponse<CountryListResponse> GetCountriesWithHttpInfo(List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<RestCountry> localVarResponse = GetCountriesCodeWithHttpInfo(code, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RestCountry</returns>
        public VRPayment.Client.ApiResponse<RestCountry> GetCountriesCodeWithHttpInfo(string code, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'code' is set
            if (code == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'code' when calling CountriesService->GetCountriesCode");
            }
            ...
            localVarRequestOptions.PathParameters.Add("code", VRPayment.Client.ClientUtils.ParameterToString(code)); // path parameter
            if (expand != null)
            {
                localVarRequestOptions.QueryParameters.Add(VRPayment.Client.ClientUtils.ParameterToMultiMap("multi", "expand", expand));
            }
        ...
        {
            VRPayment.Client.ApiResponse<List<RestCountryState>> localVarResponse = GetCountriesCountryCodeStatesWithHttpInfo(countryCode);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;RestCountryState&gt;</returns>
        public VRPayment.Client.ApiResponse<List<RestCountryState>> GetCountriesCountryCodeStatesWithHttpInfo(string countryCode, int operationIndex = 0)
        {
            // verify the required parameter 'countryCode' is set
            if (countryCode == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'countryCode' when calling CountriesService->GetCountriesCountryCodeStates");
            }
            ...
            localVarRequestOptions.PathParameters.Add("countryCode", VRPayment.Client.ClientUtils.ParameterToString(countryCode)); // path parameter
        ...
        {
            VRPayment.Client.ApiResponse<CountrySearchResponse> localVarResponse = GetCountriesSearchWithHttpInfo(expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CountrySearchResponse</returns>
        public VRPayment.Client.ApiResponse<CountrySearchResponse> GetCountriesSearchWithHttpInfo(List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<List<RestCountryState>> localVarResponse = GetCountriesStatesWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;RestCountryState&gt;</returns>
        public VRPayment.Client.ApiResponse<List<RestCountryState>> GetCountriesStatesWithHttpInfo(int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<RestCountryState> localVarResponse = GetCountriesStatesIdWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RestCountryState</returns>
        public VRPayment.Client.ApiResponse<RestCountryState> GetCountriesStatesIdWithHttpInfo(string id, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'id' when calling CountriesService->GetCountriesStatesId");
            }
