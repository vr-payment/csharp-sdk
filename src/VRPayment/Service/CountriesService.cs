...
namespace VRPayment.Service
{
    ...
    public partial class CountriesService : ICountriesService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CountryListResponse</returns>
        public VRPayment.Client.ApiResponse<CountryListResponse> GetCountriesWithHttpInfo(List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RestCountry</returns>
        public VRPayment.Client.ApiResponse<RestCountry> GetCountriesCodeWithHttpInfo(string code, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CountrySearchResponse</returns>
        public VRPayment.Client.ApiResponse<CountrySearchResponse> GetCountriesSearchWithHttpInfo(List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
