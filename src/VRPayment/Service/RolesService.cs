...
namespace VRPayment.Service
{
    ...
    public partial class RolesService : IRolesService
    {
        ...
        /// <returns></returns>
        public RolesService(VRPayment.Client.Configuration configuration)
        {
        ...
        public RolesService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> DeleteRolesIdWithHttpInfo(long id, int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<RoleListResponse> localVarResponse = GetRolesWithHttpInfo(after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RoleListResponse</returns>
        public VRPayment.Client.ApiResponse<RoleListResponse> GetRolesWithHttpInfo(long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<Role> localVarResponse = GetRolesIdWithHttpInfo(id, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Role</returns>
        public VRPayment.Client.ApiResponse<Role> GetRolesIdWithHttpInfo(long id, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<RoleSearchResponse> localVarResponse = GetRolesSearchWithHttpInfo(expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RoleSearchResponse</returns>
        public VRPayment.Client.ApiResponse<RoleSearchResponse> GetRolesSearchWithHttpInfo(List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<Role> localVarResponse = PatchRolesIdWithHttpInfo(id, roleUpdate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Role</returns>
        public VRPayment.Client.ApiResponse<Role> PatchRolesIdWithHttpInfo(long id, RoleUpdate roleUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'roleUpdate' is set
            if (roleUpdate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'roleUpdate' when calling RolesService->PatchRolesId");
            }
        ...
        {
            VRPayment.Client.ApiResponse<Role> localVarResponse = PostRolesWithHttpInfo(roleCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Role</returns>
        public VRPayment.Client.ApiResponse<Role> PostRolesWithHttpInfo(RoleCreate roleCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'roleCreate' is set
            if (roleCreate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'roleCreate' when calling RolesService->PostRoles");
            }
