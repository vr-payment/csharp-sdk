...
namespace VRPayment.Service
{
    ...
    public partial class RolesService : IRolesService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RoleListResponse</returns>
        public VRPayment.Client.ApiResponse<RoleListResponse> GetRolesWithHttpInfo(long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Role</returns>
        public VRPayment.Client.ApiResponse<Role> GetRolesIdWithHttpInfo(long id, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RoleSearchResponse</returns>
        public VRPayment.Client.ApiResponse<RoleSearchResponse> GetRolesSearchWithHttpInfo(List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Role</returns>
        public VRPayment.Client.ApiResponse<Role> PatchRolesIdWithHttpInfo(long id, RoleUpdate roleUpdate, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Role</returns>
        public VRPayment.Client.ApiResponse<Role> PostRolesWithHttpInfo(RoleCreate roleCreate, List<string>? expand = default, int operationIndex = 0)
        {
