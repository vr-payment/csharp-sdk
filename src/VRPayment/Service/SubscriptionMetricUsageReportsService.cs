...
namespace VRPayment.Service
{
    ...
    public partial class SubscriptionMetricUsageReportsService : ISubscriptionMetricUsageReportsService
    {
        ...
        /// <returns></returns>
        public SubscriptionMetricUsageReportsService(VRPayment.Client.Configuration configuration)
        {
        ...
        public SubscriptionMetricUsageReportsService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        {
            VRPayment.Client.ApiResponse<MetricUsageReportListResponse> localVarResponse = GetSubscriptionsMetricUsageReportsWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MetricUsageReportListResponse</returns>
        public VRPayment.Client.ApiResponse<MetricUsageReportListResponse> GetSubscriptionsMetricUsageReportsWithHttpInfo(long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<SubscriptionMetricUsageReport> localVarResponse = GetSubscriptionsMetricUsageReportsIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionMetricUsageReport</returns>
        public VRPayment.Client.ApiResponse<SubscriptionMetricUsageReport> GetSubscriptionsMetricUsageReportsIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<MetricUsageReportSearchResponse> localVarResponse = GetSubscriptionsMetricUsageReportsSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MetricUsageReportSearchResponse</returns>
        public VRPayment.Client.ApiResponse<MetricUsageReportSearchResponse> GetSubscriptionsMetricUsageReportsSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<SubscriptionMetricUsageReport> localVarResponse = PostSubscriptionsMetricUsageReportsWithHttpInfo(space, subscriptionMetricUsageReportCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionMetricUsageReport</returns>
        public VRPayment.Client.ApiResponse<SubscriptionMetricUsageReport> PostSubscriptionsMetricUsageReportsWithHttpInfo(long space, SubscriptionMetricUsageReportCreate subscriptionMetricUsageReportCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'subscriptionMetricUsageReportCreate' is set
            if (subscriptionMetricUsageReportCreate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'subscriptionMetricUsageReportCreate' when calling SubscriptionMetricUsageReportsService->PostSubscriptionsMetricUsageReports");
            }
