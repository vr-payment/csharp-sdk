...
namespace VRPayment.Service
{
    ...
    public partial class SubscriptionMetricUsageReportsService : ISubscriptionMetricUsageReportsService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MetricUsageReportListResponse</returns>
        public VRPayment.Client.ApiResponse<MetricUsageReportListResponse> GetSubscriptionsMetricUsageReportsWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionMetricUsageReport</returns>
        public VRPayment.Client.ApiResponse<SubscriptionMetricUsageReport> GetSubscriptionsMetricUsageReportsIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MetricUsageReportSearchResponse</returns>
        public VRPayment.Client.ApiResponse<MetricUsageReportSearchResponse> GetSubscriptionsMetricUsageReportsSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionMetricUsageReport</returns>
        public VRPayment.Client.ApiResponse<SubscriptionMetricUsageReport> PostSubscriptionsMetricUsageReportsWithHttpInfo(long space, SubscriptionMetricUsageReportCreate subscriptionMetricUsageReportCreate, List<string>? expand = default, int operationIndex = 0)
        {
