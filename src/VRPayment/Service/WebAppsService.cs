...
namespace VRPayment.Service
{
    ...
    public partial class WebAppsService : IWebAppsService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of WebAppConfirmationResponse</returns>
        public VRPayment.Client.ApiResponse<WebAppConfirmationResponse> PostWebAppsConfirmCodeWithHttpInfo(string code, List<string>? expand = default, int operationIndex = 0)
        {
