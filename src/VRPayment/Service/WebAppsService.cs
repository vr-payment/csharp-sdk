...
namespace VRPayment.Service
{
    ...
    public partial class WebAppsService : IWebAppsService
    {
        ...
        /// <returns></returns>
        public WebAppsService(VRPayment.Client.Configuration configuration)
        {
        ...
        public WebAppsService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        {
            VRPayment.Client.ApiResponse<bool> localVarResponse = GetWebAppsInstalledWithHttpInfo(space);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of bool</returns>
        public VRPayment.Client.ApiResponse<bool> GetWebAppsInstalledWithHttpInfo(long space, int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<WebAppConfirmationResponse> localVarResponse = PostWebAppsConfirmCodeWithHttpInfo(code, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of WebAppConfirmationResponse</returns>
        public VRPayment.Client.ApiResponse<WebAppConfirmationResponse> PostWebAppsConfirmCodeWithHttpInfo(string code, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'code' is set
            if (code == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'code' when calling WebAppsService->PostWebAppsConfirmCode");
            }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> PostWebAppsUninstallWithHttpInfo(long space, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
