...
namespace VRPayment.Service
{
    ...
    public partial class AccountsService : IAccountsService
    {
        ...
        /// <returns></returns>
        public AccountsService(VRPayment.Client.Configuration configuration)
        {
        ...
        public AccountsService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> DeleteAccountsIdWithHttpInfo(long id, int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<AccountListResponse> localVarResponse = GetAccountsWithHttpInfo(after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AccountListResponse</returns>
        public VRPayment.Client.ApiResponse<AccountListResponse> GetAccountsWithHttpInfo(long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<Account> localVarResponse = GetAccountsIdWithHttpInfo(id, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Account</returns>
        public VRPayment.Client.ApiResponse<Account> GetAccountsIdWithHttpInfo(long id, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<AccountSearchResponse> localVarResponse = GetAccountsSearchWithHttpInfo(expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AccountSearchResponse</returns>
        public VRPayment.Client.ApiResponse<AccountSearchResponse> GetAccountsSearchWithHttpInfo(List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<Account> localVarResponse = PatchAccountsIdWithHttpInfo(id, accountUpdate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Account</returns>
        public VRPayment.Client.ApiResponse<Account> PatchAccountsIdWithHttpInfo(long id, AccountUpdate accountUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'accountUpdate' is set
            if (accountUpdate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'accountUpdate' when calling AccountsService->PatchAccountsId");
            }
        ...
        {
            VRPayment.Client.ApiResponse<Account> localVarResponse = PostAccountsWithHttpInfo(accountCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Account</returns>
        public VRPayment.Client.ApiResponse<Account> PostAccountsWithHttpInfo(AccountCreate accountCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'accountCreate' is set
            if (accountCreate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'accountCreate' when calling AccountsService->PostAccounts");
            }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> PostAccountsIdActivateWithHttpInfo(long id, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> PostAccountsIdDeactivateWithHttpInfo(long id, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
