...
namespace VRPayment.Service
{
    ...
    public partial class AccountsService : IAccountsService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AccountListResponse</returns>
        public VRPayment.Client.ApiResponse<AccountListResponse> GetAccountsWithHttpInfo(long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Account</returns>
        public VRPayment.Client.ApiResponse<Account> GetAccountsIdWithHttpInfo(long id, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AccountSearchResponse</returns>
        public VRPayment.Client.ApiResponse<AccountSearchResponse> GetAccountsSearchWithHttpInfo(List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Account</returns>
        public VRPayment.Client.ApiResponse<Account> PatchAccountsIdWithHttpInfo(long id, AccountUpdate accountUpdate, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Account</returns>
        public VRPayment.Client.ApiResponse<Account> PostAccountsWithHttpInfo(AccountCreate accountCreate, List<string>? expand = default, int operationIndex = 0)
        {
