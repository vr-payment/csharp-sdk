...
namespace VRPayment.Service
{
    ...
    public partial class SubscriptionMetricsService : ISubscriptionMetricsService
    {
        ...
        /// <returns></returns>
        public SubscriptionMetricsService(VRPayment.Client.Configuration configuration)
        {
        ...
        public SubscriptionMetricsService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> DeleteSubscriptionsMetricsIdWithHttpInfo(long id, long space, int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<MetricListResponse> localVarResponse = GetSubscriptionsMetricsWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MetricListResponse</returns>
        public VRPayment.Client.ApiResponse<MetricListResponse> GetSubscriptionsMetricsWithHttpInfo(long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<SubscriptionMetric> localVarResponse = GetSubscriptionsMetricsIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionMetric</returns>
        public VRPayment.Client.ApiResponse<SubscriptionMetric> GetSubscriptionsMetricsIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<MetricSearchResponse> localVarResponse = GetSubscriptionsMetricsSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MetricSearchResponse</returns>
        public VRPayment.Client.ApiResponse<MetricSearchResponse> GetSubscriptionsMetricsSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<SubscriptionMetric> localVarResponse = PatchSubscriptionsMetricsIdWithHttpInfo(id, space, subscriptionMetricActive, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionMetric</returns>
        public VRPayment.Client.ApiResponse<SubscriptionMetric> PatchSubscriptionsMetricsIdWithHttpInfo(long id, long space, SubscriptionMetricActive subscriptionMetricActive, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'subscriptionMetricActive' is set
            if (subscriptionMetricActive == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'subscriptionMetricActive' when calling SubscriptionMetricsService->PatchSubscriptionsMetricsId");
            }
        ...
        {
            VRPayment.Client.ApiResponse<SubscriptionMetric> localVarResponse = PostSubscriptionsMetricsWithHttpInfo(space, subscriptionMetricCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionMetric</returns>
        public VRPayment.Client.ApiResponse<SubscriptionMetric> PostSubscriptionsMetricsWithHttpInfo(long space, SubscriptionMetricCreate subscriptionMetricCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'subscriptionMetricCreate' is set
            if (subscriptionMetricCreate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'subscriptionMetricCreate' when calling SubscriptionMetricsService->PostSubscriptionsMetrics");
            }
