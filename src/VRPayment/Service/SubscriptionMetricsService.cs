...
namespace VRPayment.Service
{
    ...
    public partial class SubscriptionMetricsService : ISubscriptionMetricsService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MetricListResponse</returns>
        public VRPayment.Client.ApiResponse<MetricListResponse> GetSubscriptionsMetricsWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionMetric</returns>
        public VRPayment.Client.ApiResponse<SubscriptionMetric> GetSubscriptionsMetricsIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MetricSearchResponse</returns>
        public VRPayment.Client.ApiResponse<MetricSearchResponse> GetSubscriptionsMetricsSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionMetric</returns>
        public VRPayment.Client.ApiResponse<SubscriptionMetric> PatchSubscriptionsMetricsIdWithHttpInfo(long id, long space, SubscriptionMetricActive subscriptionMetricActive, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionMetric</returns>
        public VRPayment.Client.ApiResponse<SubscriptionMetric> PostSubscriptionsMetricsWithHttpInfo(long space, SubscriptionMetricCreate subscriptionMetricCreate, List<string>? expand = default, int operationIndex = 0)
        {
