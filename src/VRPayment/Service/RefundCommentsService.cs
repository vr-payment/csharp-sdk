...
namespace VRPayment.Service
{
    ...
    public partial class RefundCommentsService : IRefundCommentsService
    {
        ...
        /// <returns></returns>
        public RefundCommentsService(VRPayment.Client.Configuration configuration)
        {
        ...
        public RefundCommentsService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> DeletePaymentRefundsRefundIdCommentsIdWithHttpInfo(long refundId, long id, long space, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.PathParameters.Add("refundId", VRPayment.Client.ClientUtils.ParameterToString(refundId)); // path parameter
        ...
        {
            VRPayment.Client.ApiResponse<RefundCommentListResponse> localVarResponse = GetPaymentRefundsRefundIdCommentsWithHttpInfo(refundId, space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RefundCommentListResponse</returns>
        public VRPayment.Client.ApiResponse<RefundCommentListResponse> GetPaymentRefundsRefundIdCommentsWithHttpInfo(long refundId, long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<RefundComment> localVarResponse = GetPaymentRefundsRefundIdCommentsIdWithHttpInfo(refundId, id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RefundComment</returns>
        public VRPayment.Client.ApiResponse<RefundComment> GetPaymentRefundsRefundIdCommentsIdWithHttpInfo(long refundId, long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<RefundCommentSearchResponse> localVarResponse = GetPaymentRefundsRefundIdCommentsSearchWithHttpInfo(refundId, space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RefundCommentSearchResponse</returns>
        public VRPayment.Client.ApiResponse<RefundCommentSearchResponse> GetPaymentRefundsRefundIdCommentsSearchWithHttpInfo(long refundId, long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<RefundComment> localVarResponse = PatchPaymentRefundsRefundIdCommentsIdWithHttpInfo(refundId, id, space, refundCommentActive, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RefundComment</returns>
        public VRPayment.Client.ApiResponse<RefundComment> PatchPaymentRefundsRefundIdCommentsIdWithHttpInfo(long refundId, long id, long space, RefundCommentActive refundCommentActive, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'refundCommentActive' is set
            if (refundCommentActive == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'refundCommentActive' when calling RefundCommentsService->PatchPaymentRefundsRefundIdCommentsId");
            }
        ...
        {
            VRPayment.Client.ApiResponse<RefundComment> localVarResponse = PostPaymentRefundsRefundIdCommentsWithHttpInfo(refundId, space, refundCommentCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RefundComment</returns>
        public VRPayment.Client.ApiResponse<RefundComment> PostPaymentRefundsRefundIdCommentsWithHttpInfo(long refundId, long space, RefundCommentCreate refundCommentCreate, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'refundCommentCreate' is set
            if (refundCommentCreate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'refundCommentCreate' when calling RefundCommentsService->PostPaymentRefundsRefundIdComments");
            }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> PostPaymentRefundsRefundIdCommentsIdPinWithHttpInfo(long refundId, long id, long space, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> PostPaymentRefundsRefundIdCommentsIdUnpinWithHttpInfo(long refundId, long id, long space, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
