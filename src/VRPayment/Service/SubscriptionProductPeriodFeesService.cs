...
namespace VRPayment.Service
{
    ...
    public partial class SubscriptionProductPeriodFeesService : ISubscriptionProductPeriodFeesService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductPeriodFeeListResponse</returns>
        public VRPayment.Client.ApiResponse<ProductPeriodFeeListResponse> GetSubscriptionsProductsPeriodFeesWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductPeriodFee</returns>
        public VRPayment.Client.ApiResponse<ProductPeriodFee> GetSubscriptionsProductsPeriodFeesIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductPeriodFeeSearchResponse</returns>
        public VRPayment.Client.ApiResponse<ProductPeriodFeeSearchResponse> GetSubscriptionsProductsPeriodFeesSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductPeriodFee</returns>
        public VRPayment.Client.ApiResponse<ProductPeriodFee> PatchSubscriptionsProductsPeriodFeesIdWithHttpInfo(long id, long space, ProductPeriodFeeUpdate productPeriodFeeUpdate, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductPeriodFee</returns>
        public VRPayment.Client.ApiResponse<ProductPeriodFee> PostSubscriptionsProductsPeriodFeesWithHttpInfo(long space, ProductPeriodFeeUpdate productPeriodFeeUpdate, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'productPeriodFeeUpdate' is set
            if (productPeriodFeeUpdate == null)
            {
