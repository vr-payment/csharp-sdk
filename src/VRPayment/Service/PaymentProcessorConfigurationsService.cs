...
namespace VRPayment.Service
{
    ...
    public partial class PaymentProcessorConfigurationsService : IPaymentProcessorConfigurationsService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentProcessorConfiguration</returns>
        public VRPayment.Client.ApiResponse<PaymentProcessorConfiguration> GetPaymentProcessorConfigurationsIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentProcessorConfiguration</returns>
        public VRPayment.Client.ApiResponse<PaymentProcessorConfiguration> PatchPaymentProcessorConfigurationsIdWithHttpInfo(long id, long space, PaymentProcessorConfigurationActive paymentProcessorConfigurationActive, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentProcessorConfiguration</returns>
        public VRPayment.Client.ApiResponse<PaymentProcessorConfiguration> PostPaymentProcessorConfigurationsWithHttpInfo(long space, PaymentProcessorConfigurationCreate paymentProcessorConfigurationCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
