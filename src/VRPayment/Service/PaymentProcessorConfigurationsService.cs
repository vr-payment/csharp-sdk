...
namespace VRPayment.Service
{
    ...
    public partial class PaymentProcessorConfigurationsService : IPaymentProcessorConfigurationsService
    {
        ...
        /// <returns></returns>
        public PaymentProcessorConfigurationsService(VRPayment.Client.Configuration configuration)
        {
        ...
        public PaymentProcessorConfigurationsService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> DeletePaymentProcessorConfigurationsIdWithHttpInfo(long id, long space, int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<PaymentProcessorConfigurationListResponse> localVarResponse = GetPaymentProcessorConfigurationsWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentProcessorConfigurationListResponse</returns>
        public VRPayment.Client.ApiResponse<PaymentProcessorConfigurationListResponse> GetPaymentProcessorConfigurationsWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<PaymentProcessorConfiguration> localVarResponse = GetPaymentProcessorConfigurationsIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentProcessorConfiguration</returns>
        public VRPayment.Client.ApiResponse<PaymentProcessorConfiguration> GetPaymentProcessorConfigurationsIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<PaymentProcessorConfigurationSearchResponse> localVarResponse = GetPaymentProcessorConfigurationsSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentProcessorConfigurationSearchResponse</returns>
        public VRPayment.Client.ApiResponse<PaymentProcessorConfigurationSearchResponse> GetPaymentProcessorConfigurationsSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<PaymentProcessorConfiguration> localVarResponse = PatchPaymentProcessorConfigurationsIdWithHttpInfo(id, space, paymentProcessorConfigurationActive, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentProcessorConfiguration</returns>
        public VRPayment.Client.ApiResponse<PaymentProcessorConfiguration> PatchPaymentProcessorConfigurationsIdWithHttpInfo(long id, long space, PaymentProcessorConfigurationActive paymentProcessorConfigurationActive, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'paymentProcessorConfigurationActive' is set
            if (paymentProcessorConfigurationActive == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'paymentProcessorConfigurationActive' when calling PaymentProcessorConfigurationsService->PatchPaymentProcessorConfigurationsId");
            }
        ...
        {
            VRPayment.Client.ApiResponse<PaymentProcessorConfiguration> localVarResponse = PostPaymentProcessorConfigurationsWithHttpInfo(space, paymentProcessorConfigurationCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentProcessorConfiguration</returns>
        public VRPayment.Client.ApiResponse<PaymentProcessorConfiguration> PostPaymentProcessorConfigurationsWithHttpInfo(long space, PaymentProcessorConfigurationCreate paymentProcessorConfigurationCreate, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'paymentProcessorConfigurationCreate' is set
            if (paymentProcessorConfigurationCreate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'paymentProcessorConfigurationCreate' when calling PaymentProcessorConfigurationsService->PostPaymentProcessorConfigurations");
            }
