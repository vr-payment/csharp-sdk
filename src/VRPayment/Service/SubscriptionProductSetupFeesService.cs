...
namespace VRPayment.Service
{
    ...
    public partial class SubscriptionProductSetupFeesService : ISubscriptionProductSetupFeesService
    {
        ...
        /// <returns></returns>
        public SubscriptionProductSetupFeesService(VRPayment.Client.Configuration configuration)
        {
        ...
        public SubscriptionProductSetupFeesService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> DeleteSubscriptionsProductsSetupFeesIdWithHttpInfo(long id, long space, int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<ProductSetupFeeListResponse> localVarResponse = GetSubscriptionsProductsSetupFeesWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductSetupFeeListResponse</returns>
        public VRPayment.Client.ApiResponse<ProductSetupFeeListResponse> GetSubscriptionsProductsSetupFeesWithHttpInfo(long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<ProductSetupFee> localVarResponse = GetSubscriptionsProductsSetupFeesIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductSetupFee</returns>
        public VRPayment.Client.ApiResponse<ProductSetupFee> GetSubscriptionsProductsSetupFeesIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<ProductSetupFeeSearchResponse> localVarResponse = GetSubscriptionsProductsSetupFeesSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductSetupFeeSearchResponse</returns>
        public VRPayment.Client.ApiResponse<ProductSetupFeeSearchResponse> GetSubscriptionsProductsSetupFeesSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<ProductSetupFee> localVarResponse = PatchSubscriptionsProductsSetupFeesIdWithHttpInfo(id, space, productSetupFeeUpdate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductSetupFee</returns>
        public VRPayment.Client.ApiResponse<ProductSetupFee> PatchSubscriptionsProductsSetupFeesIdWithHttpInfo(long id, long space, ProductSetupFeeUpdate productSetupFeeUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'productSetupFeeUpdate' is set
            if (productSetupFeeUpdate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'productSetupFeeUpdate' when calling SubscriptionProductSetupFeesService->PatchSubscriptionsProductsSetupFeesId");
            }
        ...
        {
            VRPayment.Client.ApiResponse<ProductSetupFee> localVarResponse = PostSubscriptionsProductsSetupFeesWithHttpInfo(space, productSetupFeeUpdate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductSetupFee</returns>
        public VRPayment.Client.ApiResponse<ProductSetupFee> PostSubscriptionsProductsSetupFeesWithHttpInfo(long space, ProductSetupFeeUpdate productSetupFeeUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'productSetupFeeUpdate' is set
            if (productSetupFeeUpdate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'productSetupFeeUpdate' when calling SubscriptionProductSetupFeesService->PostSubscriptionsProductsSetupFees");
            }
