...
namespace VRPayment.Service
{
    ...
    public partial class SubscriptionPeriodBillsService : ISubscriptionPeriodBillsService
    {
        ...
        /// <returns></returns>
        public SubscriptionPeriodBillsService(VRPayment.Client.Configuration configuration)
        {
        ...
        public SubscriptionPeriodBillsService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        {
            VRPayment.Client.ApiResponse<SubscriptionPeriodBillListResponse> localVarResponse = GetSubscriptionsPeriodBillsWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionPeriodBillListResponse</returns>
        public VRPayment.Client.ApiResponse<SubscriptionPeriodBillListResponse> GetSubscriptionsPeriodBillsWithHttpInfo(long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<SubscriptionPeriodBill> localVarResponse = GetSubscriptionsPeriodBillsIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionPeriodBill</returns>
        public VRPayment.Client.ApiResponse<SubscriptionPeriodBill> GetSubscriptionsPeriodBillsIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<SubscriptionPeriodBillSearchResponse> localVarResponse = GetSubscriptionsPeriodBillsSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionPeriodBillSearchResponse</returns>
        public VRPayment.Client.ApiResponse<SubscriptionPeriodBillSearchResponse> GetSubscriptionsPeriodBillsSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<SubscriptionPeriodBill> localVarResponse = PostSubscriptionsPeriodBillsIdCloseWithHttpInfo(id, currentDate, createNextPeriod, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionPeriodBill</returns>
        public VRPayment.Client.ApiResponse<SubscriptionPeriodBill> PostSubscriptionsPeriodBillsIdCloseWithHttpInfo(long id, DateTime currentDate, bool createNextPeriod, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
            ...
            localVarRequestOptions.PathParameters.Add("id", VRPayment.Client.ClientUtils.ParameterToString(id)); // path parameter
            localVarRequestOptions.QueryParameters.Add(VRPayment.Client.ClientUtils.ParameterToMultiMap("", "currentDate", currentDate));
            localVarRequestOptions.QueryParameters.Add(VRPayment.Client.ClientUtils.ParameterToMultiMap("", "createNextPeriod", createNextPeriod));
            if (expand != null)
            {
                localVarRequestOptions.QueryParameters.Add(VRPayment.Client.ClientUtils.ParameterToMultiMap("multi", "expand", expand));
            }
