...
namespace VRPayment.Service
{
    ...
    public partial class SubscriptionPeriodBillsService : ISubscriptionPeriodBillsService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionPeriodBillListResponse</returns>
        public VRPayment.Client.ApiResponse<SubscriptionPeriodBillListResponse> GetSubscriptionsPeriodBillsWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionPeriodBill</returns>
        public VRPayment.Client.ApiResponse<SubscriptionPeriodBill> GetSubscriptionsPeriodBillsIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionPeriodBillSearchResponse</returns>
        public VRPayment.Client.ApiResponse<SubscriptionPeriodBillSearchResponse> GetSubscriptionsPeriodBillsSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionPeriodBill</returns>
        public VRPayment.Client.ApiResponse<SubscriptionPeriodBill> PostSubscriptionsPeriodBillsIdCloseWithHttpInfo(long id, DateTime currentDate, bool createNextPeriod, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
