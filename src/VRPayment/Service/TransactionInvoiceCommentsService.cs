...
namespace VRPayment.Service
{
    ...
    public partial class TransactionInvoiceCommentsService : ITransactionInvoiceCommentsService
    {
        ...
        /// <returns></returns>
        public TransactionInvoiceCommentsService(VRPayment.Client.Configuration configuration)
        {
        ...
        public TransactionInvoiceCommentsService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> DeletePaymentTransactionsInvoicesInvoiceIdCommentsIdWithHttpInfo(long invoiceId, long id, long space, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.PathParameters.Add("invoiceId", VRPayment.Client.ClientUtils.ParameterToString(invoiceId)); // path parameter
        ...
        {
            VRPayment.Client.ApiResponse<InvoiceCommentListResponse> localVarResponse = GetPaymentTransactionsInvoicesInvoiceIdCommentsWithHttpInfo(invoiceId, space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of InvoiceCommentListResponse</returns>
        public VRPayment.Client.ApiResponse<InvoiceCommentListResponse> GetPaymentTransactionsInvoicesInvoiceIdCommentsWithHttpInfo(long invoiceId, long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<TransactionInvoiceComment> localVarResponse = GetPaymentTransactionsInvoicesInvoiceIdCommentsIdWithHttpInfo(invoiceId, id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionInvoiceComment</returns>
        public VRPayment.Client.ApiResponse<TransactionInvoiceComment> GetPaymentTransactionsInvoicesInvoiceIdCommentsIdWithHttpInfo(long invoiceId, long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<InvoiceCommentSearchResponse> localVarResponse = GetPaymentTransactionsInvoicesInvoiceIdCommentsSearchWithHttpInfo(invoiceId, space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of InvoiceCommentSearchResponse</returns>
        public VRPayment.Client.ApiResponse<InvoiceCommentSearchResponse> GetPaymentTransactionsInvoicesInvoiceIdCommentsSearchWithHttpInfo(long invoiceId, long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<TransactionInvoiceComment> localVarResponse = PatchPaymentTransactionsInvoicesInvoiceIdCommentsIdWithHttpInfo(invoiceId, id, space, transactionInvoiceCommentActive, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionInvoiceComment</returns>
        public VRPayment.Client.ApiResponse<TransactionInvoiceComment> PatchPaymentTransactionsInvoicesInvoiceIdCommentsIdWithHttpInfo(long invoiceId, long id, long space, TransactionInvoiceCommentActive transactionInvoiceCommentActive, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'transactionInvoiceCommentActive' is set
            if (transactionInvoiceCommentActive == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'transactionInvoiceCommentActive' when calling TransactionInvoiceCommentsService->PatchPaymentTransactionsInvoicesInvoiceIdCommentsId");
            }
        ...
        {
            VRPayment.Client.ApiResponse<TransactionInvoiceComment> localVarResponse = PostPaymentTransactionsInvoicesInvoiceIdCommentsWithHttpInfo(invoiceId, space, transactionInvoiceCommentCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionInvoiceComment</returns>
        public VRPayment.Client.ApiResponse<TransactionInvoiceComment> PostPaymentTransactionsInvoicesInvoiceIdCommentsWithHttpInfo(long invoiceId, long space, TransactionInvoiceCommentCreate transactionInvoiceCommentCreate, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'transactionInvoiceCommentCreate' is set
            if (transactionInvoiceCommentCreate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'transactionInvoiceCommentCreate' when calling TransactionInvoiceCommentsService->PostPaymentTransactionsInvoicesInvoiceIdComments");
            }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> PostPaymentTransactionsInvoicesInvoiceIdCommentsIdPinWithHttpInfo(long invoiceId, long id, long space, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> PostPaymentTransactionsInvoicesInvoiceIdCommentsIdUnpinWithHttpInfo(long invoiceId, long id, long space, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
