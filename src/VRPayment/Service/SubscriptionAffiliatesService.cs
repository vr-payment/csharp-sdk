...
namespace VRPayment.Service
{
    ...
    public partial class SubscriptionAffiliatesService : ISubscriptionAffiliatesService
    {
        ...
        /// <returns></returns>
        public SubscriptionAffiliatesService(VRPayment.Client.Configuration configuration)
        {
        ...
        public SubscriptionAffiliatesService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> DeleteSubscriptionsAffiliatesIdWithHttpInfo(long id, long space, int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<SubscriptionAffiliateListResponse> localVarResponse = GetSubscriptionsAffiliatesWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionAffiliateListResponse</returns>
        public VRPayment.Client.ApiResponse<SubscriptionAffiliateListResponse> GetSubscriptionsAffiliatesWithHttpInfo(long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<SubscriptionAffiliate> localVarResponse = GetSubscriptionsAffiliatesIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionAffiliate</returns>
        public VRPayment.Client.ApiResponse<SubscriptionAffiliate> GetSubscriptionsAffiliatesIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<SubscriptionAffiliateSearchResponse> localVarResponse = GetSubscriptionsAffiliatesSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionAffiliateSearchResponse</returns>
        public VRPayment.Client.ApiResponse<SubscriptionAffiliateSearchResponse> GetSubscriptionsAffiliatesSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<SubscriptionAffiliate> localVarResponse = PatchSubscriptionsAffiliatesIdWithHttpInfo(id, space, subscriptionAffiliateUpdate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionAffiliate</returns>
        public VRPayment.Client.ApiResponse<SubscriptionAffiliate> PatchSubscriptionsAffiliatesIdWithHttpInfo(long id, long space, SubscriptionAffiliateUpdate subscriptionAffiliateUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'subscriptionAffiliateUpdate' is set
            if (subscriptionAffiliateUpdate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'subscriptionAffiliateUpdate' when calling SubscriptionAffiliatesService->PatchSubscriptionsAffiliatesId");
            }
        ...
        {
            VRPayment.Client.ApiResponse<SubscriptionAffiliate> localVarResponse = PostSubscriptionsAffiliatesWithHttpInfo(space, subscriptionAffiliateCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionAffiliate</returns>
        public VRPayment.Client.ApiResponse<SubscriptionAffiliate> PostSubscriptionsAffiliatesWithHttpInfo(long space, SubscriptionAffiliateCreate subscriptionAffiliateCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'subscriptionAffiliateCreate' is set
            if (subscriptionAffiliateCreate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'subscriptionAffiliateCreate' when calling SubscriptionAffiliatesService->PostSubscriptionsAffiliates");
            }
