...
namespace VRPayment.Service
{
    ...
    public partial class SubscriptionProductsService : ISubscriptionProductsService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductListResponse</returns>
        public VRPayment.Client.ApiResponse<ProductListResponse> GetSubscriptionsProductsWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionProduct</returns>
        public VRPayment.Client.ApiResponse<SubscriptionProduct> GetSubscriptionsProductsIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductSearchResponse</returns>
        public VRPayment.Client.ApiResponse<ProductSearchResponse> GetSubscriptionsProductsSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionProduct</returns>
        public VRPayment.Client.ApiResponse<SubscriptionProduct> PatchSubscriptionsProductsIdWithHttpInfo(long id, long space, SubscriptionProductActive subscriptionProductActive, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionProduct</returns>
        public VRPayment.Client.ApiResponse<SubscriptionProduct> PostSubscriptionsProductsWithHttpInfo(long space, SubscriptionProductCreate subscriptionProductCreate, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionProductRetirement</returns>
        public VRPayment.Client.ApiResponse<SubscriptionProductRetirement> PostSubscriptionsProductsIdRetireWithHttpInfo(long id, long space, SubscriptionProductRetirementRequest subscriptionProductRetirementRequest, List<string>? expand = default, int operationIndex = 0)
        {
