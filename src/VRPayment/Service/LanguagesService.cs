...
namespace VRPayment.Service
{
    ...
    public partial class LanguagesService : ILanguagesService
    {
        ...
        /// <returns></returns>
        public LanguagesService(VRPayment.Client.Configuration configuration)
        {
        ...
        public LanguagesService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        {
            VRPayment.Client.ApiResponse<LanguageListResponse> localVarResponse = GetLanguagesWithHttpInfo(expand);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LanguageListResponse</returns>
        public VRPayment.Client.ApiResponse<LanguageListResponse> GetLanguagesWithHttpInfo(List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<RestLanguage> localVarResponse = GetLanguagesCodeWithHttpInfo(code);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RestLanguage</returns>
        public VRPayment.Client.ApiResponse<RestLanguage> GetLanguagesCodeWithHttpInfo(string code, int operationIndex = 0)
        {
            // verify the required parameter 'code' is set
            if (code == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'code' when calling LanguagesService->GetLanguagesCode");
            }
        ...
        {
            VRPayment.Client.ApiResponse<LanguageSearchResponse> localVarResponse = GetLanguagesSearchWithHttpInfo(expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LanguageSearchResponse</returns>
        public VRPayment.Client.ApiResponse<LanguageSearchResponse> GetLanguagesSearchWithHttpInfo(List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
