...
namespace VRPayment.Service
{
    ...
    public partial class LanguagesService : ILanguagesService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LanguageListResponse</returns>
        public VRPayment.Client.ApiResponse<LanguageListResponse> GetLanguagesWithHttpInfo(List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LanguageSearchResponse</returns>
        public VRPayment.Client.ApiResponse<LanguageSearchResponse> GetLanguagesSearchWithHttpInfo(List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
