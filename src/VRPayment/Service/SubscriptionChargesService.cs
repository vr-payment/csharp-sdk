...
namespace VRPayment.Service
{
    ...
    public partial class SubscriptionChargesService : ISubscriptionChargesService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionChargeListResponse</returns>
        public VRPayment.Client.ApiResponse<SubscriptionChargeListResponse> GetSubscriptionsChargesWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionCharge</returns>
        public VRPayment.Client.ApiResponse<SubscriptionCharge> GetSubscriptionsChargesIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionChargeSearchResponse</returns>
        public VRPayment.Client.ApiResponse<SubscriptionChargeSearchResponse> GetSubscriptionsChargesSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionCharge</returns>
        public VRPayment.Client.ApiResponse<SubscriptionCharge> PostSubscriptionsChargesWithHttpInfo(long space, SubscriptionChargeCreate subscriptionChargeCreate, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionCharge</returns>
        public VRPayment.Client.ApiResponse<SubscriptionCharge> PostSubscriptionsChargesIdDiscardWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
