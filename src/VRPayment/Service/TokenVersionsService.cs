...
namespace VRPayment.Service
{
    ...
    public partial class TokenVersionsService : ITokenVersionsService
    {
        ...
        /// <returns></returns>
        public TokenVersionsService(VRPayment.Client.Configuration configuration)
        {
        ...
        public TokenVersionsService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        {
            VRPayment.Client.ApiResponse<TokenVersionListResponse> localVarResponse = GetPaymentTokenVersionsWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TokenVersionListResponse</returns>
        public VRPayment.Client.ApiResponse<TokenVersionListResponse> GetPaymentTokenVersionsWithHttpInfo(long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<TokenVersion> localVarResponse = GetPaymentTokenVersionsIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TokenVersion</returns>
        public VRPayment.Client.ApiResponse<TokenVersion> GetPaymentTokenVersionsIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<TokenVersionSearchResponse> localVarResponse = GetPaymentTokenVersionsSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TokenVersionSearchResponse</returns>
        public VRPayment.Client.ApiResponse<TokenVersionSearchResponse> GetPaymentTokenVersionsSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
