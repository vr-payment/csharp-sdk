...
namespace VRPayment.Service
{
    ...
    public partial class SingleSignOnUsersService : ISingleSignOnUsersService
    {
        ...
        /// <returns></returns>
        public SingleSignOnUsersService(VRPayment.Client.Configuration configuration)
        {
        ...
        public SingleSignOnUsersService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> DeleteSingleSignOnUsersIdWithHttpInfo(long id, int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<SingleSignOnUserListResponse> localVarResponse = GetSingleSignOnUsersWithHttpInfo(after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SingleSignOnUserListResponse</returns>
        public VRPayment.Client.ApiResponse<SingleSignOnUserListResponse> GetSingleSignOnUsersWithHttpInfo(long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<SingleSignOnUser> localVarResponse = GetSingleSignOnUsersIdWithHttpInfo(id, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SingleSignOnUser</returns>
        public VRPayment.Client.ApiResponse<SingleSignOnUser> GetSingleSignOnUsersIdWithHttpInfo(long id, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<SingleSignOnUserSearchResponse> localVarResponse = GetSingleSignOnUsersSearchWithHttpInfo(expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SingleSignOnUserSearchResponse</returns>
        public VRPayment.Client.ApiResponse<SingleSignOnUserSearchResponse> GetSingleSignOnUsersSearchWithHttpInfo(List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<SingleSignOnUser> localVarResponse = PatchSingleSignOnUsersIdWithHttpInfo(id, singleSignOnUserUpdate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SingleSignOnUser</returns>
        public VRPayment.Client.ApiResponse<SingleSignOnUser> PatchSingleSignOnUsersIdWithHttpInfo(long id, SingleSignOnUserUpdate singleSignOnUserUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'singleSignOnUserUpdate' is set
            if (singleSignOnUserUpdate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'singleSignOnUserUpdate' when calling SingleSignOnUsersService->PatchSingleSignOnUsersId");
            }
        ...
        {
            VRPayment.Client.ApiResponse<SingleSignOnUser> localVarResponse = PostSingleSignOnUsersWithHttpInfo(singleSignOnUserCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SingleSignOnUser</returns>
        public VRPayment.Client.ApiResponse<SingleSignOnUser> PostSingleSignOnUsersWithHttpInfo(SingleSignOnUserCreate singleSignOnUserCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'singleSignOnUserCreate' is set
            if (singleSignOnUserCreate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'singleSignOnUserCreate' when calling SingleSignOnUsersService->PostSingleSignOnUsers");
            }
