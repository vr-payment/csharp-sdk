...
namespace VRPayment.Service
{
    ...
    public partial class SingleSignOnUsersService : ISingleSignOnUsersService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SingleSignOnUserListResponse</returns>
        public VRPayment.Client.ApiResponse<SingleSignOnUserListResponse> GetSingleSignOnUsersWithHttpInfo(long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SingleSignOnUser</returns>
        public VRPayment.Client.ApiResponse<SingleSignOnUser> GetSingleSignOnUsersIdWithHttpInfo(long id, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SingleSignOnUserSearchResponse</returns>
        public VRPayment.Client.ApiResponse<SingleSignOnUserSearchResponse> GetSingleSignOnUsersSearchWithHttpInfo(List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SingleSignOnUser</returns>
        public VRPayment.Client.ApiResponse<SingleSignOnUser> PatchSingleSignOnUsersIdWithHttpInfo(long id, SingleSignOnUserUpdate singleSignOnUserUpdate, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SingleSignOnUser</returns>
        public VRPayment.Client.ApiResponse<SingleSignOnUser> PostSingleSignOnUsersWithHttpInfo(SingleSignOnUserCreate singleSignOnUserCreate, List<string>? expand = default, int operationIndex = 0)
        {
