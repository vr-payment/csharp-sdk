...
namespace VRPayment.Service
{
    ...
    public partial class WebhookURLsService : IWebhookURLsService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of WebhookURLListResponse</returns>
        public VRPayment.Client.ApiResponse<WebhookURLListResponse> GetWebhooksUrlsWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of WebhookUrl</returns>
        public VRPayment.Client.ApiResponse<WebhookUrl> GetWebhooksUrlsIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of WebhookURLSearchResponse</returns>
        public VRPayment.Client.ApiResponse<WebhookURLSearchResponse> GetWebhooksUrlsSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of WebhookUrl</returns>
        public VRPayment.Client.ApiResponse<WebhookUrl> PatchWebhooksUrlsIdWithHttpInfo(long id, long space, WebhookUrlUpdate webhookUrlUpdate, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'webhookUrlUpdate' is set
            if (webhookUrlUpdate == null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of WebhookUrl</returns>
        public VRPayment.Client.ApiResponse<WebhookUrl> PostWebhooksUrlsWithHttpInfo(long space, WebhookUrlCreate webhookUrlCreate, List<string>? expand = default, int operationIndex = 0)
        {
