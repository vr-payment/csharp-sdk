...
namespace VRPayment.Service
{
    ...
    public partial class CurrencyBankAccountsService : ICurrencyBankAccountsService
    {
        ...
        /// <returns></returns>
        public CurrencyBankAccountsService(VRPayment.Client.Configuration configuration)
        {
        ...
        public CurrencyBankAccountsService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        {
            VRPayment.Client.ApiResponse<CurrencyBankAccountListResponse> localVarResponse = GetPaymentCurrencyBankAccountsWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrencyBankAccountListResponse</returns>
        public VRPayment.Client.ApiResponse<CurrencyBankAccountListResponse> GetPaymentCurrencyBankAccountsWithHttpInfo(long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<CurrencyBankAccount> localVarResponse = GetPaymentCurrencyBankAccountsIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrencyBankAccount</returns>
        public VRPayment.Client.ApiResponse<CurrencyBankAccount> GetPaymentCurrencyBankAccountsIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<CurrencyBankAccountSearchResponse> localVarResponse = GetPaymentCurrencyBankAccountsSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrencyBankAccountSearchResponse</returns>
        public VRPayment.Client.ApiResponse<CurrencyBankAccountSearchResponse> GetPaymentCurrencyBankAccountsSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
