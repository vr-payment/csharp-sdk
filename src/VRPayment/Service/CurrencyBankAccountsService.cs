...
namespace VRPayment.Service
{
    ...
    public partial class CurrencyBankAccountsService : ICurrencyBankAccountsService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrencyBankAccountListResponse</returns>
        public VRPayment.Client.ApiResponse<CurrencyBankAccountListResponse> GetPaymentCurrencyBankAccountsWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrencyBankAccount</returns>
        public VRPayment.Client.ApiResponse<CurrencyBankAccount> GetPaymentCurrencyBankAccountsIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrencyBankAccountSearchResponse</returns>
        public VRPayment.Client.ApiResponse<CurrencyBankAccountSearchResponse> GetPaymentCurrencyBankAccountsSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
