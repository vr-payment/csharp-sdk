...
namespace VRPayment.Service
{
    ...
    public partial class ConsumedResourcesService : IConsumedResourcesService
    {
        ...
        /// <returns></returns>
        public ConsumedResourcesService(VRPayment.Client.Configuration configuration)
        {
        ...
        public ConsumedResourcesService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        public VRPayment.Client.ApiResponse<MetricUsageListResponse> GetSpacesConsumedResourcesWithHttpInfo(DateTime startDate, DateTime endDate, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.QueryParameters.Add(VRPayment.Client.ClientUtils.ParameterToMultiMap("", "startDate", startDate));
            localVarRequestOptions.QueryParameters.Add(VRPayment.Client.ClientUtils.ParameterToMultiMap("", "endDate", endDate));
            if (expand != null)
            {
