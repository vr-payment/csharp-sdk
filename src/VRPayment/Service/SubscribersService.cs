...
namespace VRPayment.Service
{
    ...
    public partial class SubscribersService : ISubscribersService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriberListResponse</returns>
        public VRPayment.Client.ApiResponse<SubscriberListResponse> GetSubscriptionsSubscribersWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Subscriber</returns>
        public VRPayment.Client.ApiResponse<Subscriber> GetSubscriptionsSubscribersIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriberSearchResponse</returns>
        public VRPayment.Client.ApiResponse<SubscriberSearchResponse> GetSubscriptionsSubscribersSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Subscriber</returns>
        public VRPayment.Client.ApiResponse<Subscriber> PatchSubscriptionsSubscribersIdWithHttpInfo(long id, long space, SubscriberUpdate subscriberUpdate, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Subscriber</returns>
        public VRPayment.Client.ApiResponse<Subscriber> PostSubscriptionsSubscribersWithHttpInfo(long space, SubscriberCreate subscriberCreate, List<string>? expand = default, int operationIndex = 0)
        {
