...
namespace VRPayment.Service
{
    ...
    public partial class SubscribersService : ISubscribersService
    {
        ...
        /// <returns></returns>
        public SubscribersService(VRPayment.Client.Configuration configuration)
        {
        ...
        public SubscribersService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> DeleteSubscriptionsSubscribersIdWithHttpInfo(long id, long space, int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<SubscriberListResponse> localVarResponse = GetSubscriptionsSubscribersWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriberListResponse</returns>
        public VRPayment.Client.ApiResponse<SubscriberListResponse> GetSubscriptionsSubscribersWithHttpInfo(long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<Subscriber> localVarResponse = GetSubscriptionsSubscribersIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Subscriber</returns>
        public VRPayment.Client.ApiResponse<Subscriber> GetSubscriptionsSubscribersIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<SubscriberSearchResponse> localVarResponse = GetSubscriptionsSubscribersSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriberSearchResponse</returns>
        public VRPayment.Client.ApiResponse<SubscriberSearchResponse> GetSubscriptionsSubscribersSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<Subscriber> localVarResponse = PatchSubscriptionsSubscribersIdWithHttpInfo(id, space, subscriberUpdate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Subscriber</returns>
        public VRPayment.Client.ApiResponse<Subscriber> PatchSubscriptionsSubscribersIdWithHttpInfo(long id, long space, SubscriberUpdate subscriberUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'subscriberUpdate' is set
            if (subscriberUpdate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'subscriberUpdate' when calling SubscribersService->PatchSubscriptionsSubscribersId");
            }
        ...
        {
            VRPayment.Client.ApiResponse<Subscriber> localVarResponse = PostSubscriptionsSubscribersWithHttpInfo(space, subscriberCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Subscriber</returns>
        public VRPayment.Client.ApiResponse<Subscriber> PostSubscriptionsSubscribersWithHttpInfo(long space, SubscriberCreate subscriberCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'subscriberCreate' is set
            if (subscriberCreate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'subscriberCreate' when calling SubscribersService->PostSubscriptionsSubscribers");
            }
