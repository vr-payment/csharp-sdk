...
namespace VRPayment.Service
{
    ...
    public partial class CurrenciesService : ICurrenciesService
    {
        ...
        /// <returns></returns>
        public CurrenciesService(VRPayment.Client.Configuration configuration)
        {
        ...
        public CurrenciesService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        {
            VRPayment.Client.ApiResponse<CurrencyListResponse> localVarResponse = GetCurrenciesWithHttpInfo(expand);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrencyListResponse</returns>
        public VRPayment.Client.ApiResponse<CurrencyListResponse> GetCurrenciesWithHttpInfo(List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<RestCurrency> localVarResponse = GetCurrenciesCodeWithHttpInfo(code);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RestCurrency</returns>
        public VRPayment.Client.ApiResponse<RestCurrency> GetCurrenciesCodeWithHttpInfo(string code, int operationIndex = 0)
        {
            // verify the required parameter 'code' is set
            if (code == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'code' when calling CurrenciesService->GetCurrenciesCode");
            }
        ...
        {
            VRPayment.Client.ApiResponse<CurrencySearchResponse> localVarResponse = GetCurrenciesSearchWithHttpInfo(expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrencySearchResponse</returns>
        public VRPayment.Client.ApiResponse<CurrencySearchResponse> GetCurrenciesSearchWithHttpInfo(List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
