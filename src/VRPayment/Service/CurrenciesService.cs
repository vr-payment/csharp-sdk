...
namespace VRPayment.Service
{
    ...
    public partial class CurrenciesService : ICurrenciesService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrencyListResponse</returns>
        public VRPayment.Client.ApiResponse<CurrencyListResponse> GetCurrenciesWithHttpInfo(List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrencySearchResponse</returns>
        public VRPayment.Client.ApiResponse<CurrencySearchResponse> GetCurrenciesSearchWithHttpInfo(List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
