...
namespace VRPayment.Service
{
    ...
    public partial class PaymentLinksService : IPaymentLinksService
    {
        ...
        /// <returns></returns>
        public PaymentLinksService(VRPayment.Client.Configuration configuration)
        {
        ...
        public PaymentLinksService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> DeletePaymentLinksIdWithHttpInfo(long id, long space, int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<PaymentLinkListResponse> localVarResponse = GetPaymentLinksWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentLinkListResponse</returns>
        public VRPayment.Client.ApiResponse<PaymentLinkListResponse> GetPaymentLinksWithHttpInfo(long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<PaymentLink> localVarResponse = GetPaymentLinksIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentLink</returns>
        public VRPayment.Client.ApiResponse<PaymentLink> GetPaymentLinksIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<PaymentLinkSearchResponse> localVarResponse = GetPaymentLinksSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentLinkSearchResponse</returns>
        public VRPayment.Client.ApiResponse<PaymentLinkSearchResponse> GetPaymentLinksSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<PaymentLink> localVarResponse = PatchPaymentLinksIdWithHttpInfo(id, space, paymentLinkUpdate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentLink</returns>
        public VRPayment.Client.ApiResponse<PaymentLink> PatchPaymentLinksIdWithHttpInfo(long id, long space, PaymentLinkUpdate paymentLinkUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'paymentLinkUpdate' is set
            if (paymentLinkUpdate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'paymentLinkUpdate' when calling PaymentLinksService->PatchPaymentLinksId");
            }
        ...
        {
            VRPayment.Client.ApiResponse<PaymentLink> localVarResponse = PostPaymentLinksWithHttpInfo(space, paymentLinkCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentLink</returns>
        public VRPayment.Client.ApiResponse<PaymentLink> PostPaymentLinksWithHttpInfo(long space, PaymentLinkCreate paymentLinkCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'paymentLinkCreate' is set
            if (paymentLinkCreate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'paymentLinkCreate' when calling PaymentLinksService->PostPaymentLinks");
            }
