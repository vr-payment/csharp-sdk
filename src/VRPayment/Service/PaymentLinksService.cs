...
namespace VRPayment.Service
{
    ...
    public partial class PaymentLinksService : IPaymentLinksService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentLinkListResponse</returns>
        public VRPayment.Client.ApiResponse<PaymentLinkListResponse> GetPaymentLinksWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentLink</returns>
        public VRPayment.Client.ApiResponse<PaymentLink> GetPaymentLinksIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentLinkSearchResponse</returns>
        public VRPayment.Client.ApiResponse<PaymentLinkSearchResponse> GetPaymentLinksSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentLink</returns>
        public VRPayment.Client.ApiResponse<PaymentLink> PatchPaymentLinksIdWithHttpInfo(long id, long space, PaymentLinkUpdate paymentLinkUpdate, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentLink</returns>
        public VRPayment.Client.ApiResponse<PaymentLink> PostPaymentLinksWithHttpInfo(long space, PaymentLinkCreate paymentLinkCreate, List<string>? expand = default, int operationIndex = 0)
        {
