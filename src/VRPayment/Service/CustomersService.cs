...
namespace VRPayment.Service
{
    ...
    public partial class CustomersService : ICustomersService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerListResponse</returns>
        public VRPayment.Client.ApiResponse<CustomerListResponse> GetCustomersWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Customer</returns>
        public VRPayment.Client.ApiResponse<Customer> GetCustomersIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerEmailAddressListResponse</returns>
        public VRPayment.Client.ApiResponse<CustomerEmailAddressListResponse> GetCustomersIdEmailAddressesWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerSearchResponse</returns>
        public VRPayment.Client.ApiResponse<CustomerSearchResponse> GetCustomersSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Customer</returns>
        public VRPayment.Client.ApiResponse<Customer> PatchCustomersIdWithHttpInfo(long id, long space, CustomerActive customerActive, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'customerActive' is set
            if (customerActive == null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Customer</returns>
        public VRPayment.Client.ApiResponse<Customer> PostCustomersWithHttpInfo(long space, CustomerCreate customerCreate, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Customer</returns>
        public VRPayment.Client.ApiResponse<Customer> PostCustomersIdMergeOtherWithHttpInfo(long id, long other, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
