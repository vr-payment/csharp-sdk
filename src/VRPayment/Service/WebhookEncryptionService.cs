...
namespace VRPayment.Service
{
    ...
    public interface IWebhookEncryptionService : IApiAccessor
    {
        ...
        /// </summary>
        /// <exception cref="VRPayment.Client.ApiException">Thrown when when private key can not be found</exception>
    ...
    public partial class WebhookEncryptionService : IWebhookEncryptionService
    {
        ...
        /// <returns></returns>
        public WebhookEncryptionService(VRPayment.Client.Configuration configuration = null)
        {
        ...
        public VRPayment.Client.Configuration Configuration {get; set;}
