...
namespace VRPayment.Service
{
    ...
    public partial class DeliveryIndicationsService : IDeliveryIndicationsService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DeliveryIndicationListResponse</returns>
        public VRPayment.Client.ApiResponse<DeliveryIndicationListResponse> GetPaymentDeliveryIndicationsWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DeliveryIndication</returns>
        public VRPayment.Client.ApiResponse<DeliveryIndication> GetPaymentDeliveryIndicationsIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DeliveryIndicationSearchResponse</returns>
        public VRPayment.Client.ApiResponse<DeliveryIndicationSearchResponse> GetPaymentDeliveryIndicationsSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DeliveryIndication</returns>
        public VRPayment.Client.ApiResponse<DeliveryIndication> PostPaymentDeliveryIndicationsIdMarkNotSuitableWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DeliveryIndication</returns>
        public VRPayment.Client.ApiResponse<DeliveryIndication> PostPaymentDeliveryIndicationsIdMarkSuitableWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
