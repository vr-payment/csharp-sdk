...
namespace VRPayment.Service
{
    ...
    public partial class CustomerAddressesService : ICustomerAddressesService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerAddress</returns>
        public VRPayment.Client.ApiResponse<CustomerAddress> GetCustomersCustomerIdAddressesIdWithHttpInfo(long customerId, long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerAddressSearchResponse</returns>
        public VRPayment.Client.ApiResponse<CustomerAddressSearchResponse> GetCustomersCustomerIdAddressesSearchWithHttpInfo(long customerId, long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerAddress</returns>
        public VRPayment.Client.ApiResponse<CustomerAddress> PatchCustomersCustomerIdAddressesIdWithHttpInfo(long customerId, long id, long space, CustomerAddressActive customerAddressActive, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerAddress</returns>
        public VRPayment.Client.ApiResponse<CustomerAddress> PostCustomersCustomerIdAddressesWithHttpInfo(long customerId, long space, CustomerAddressCreate customerAddressCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
