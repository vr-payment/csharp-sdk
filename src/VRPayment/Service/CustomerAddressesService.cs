...
namespace VRPayment.Service
{
    ...
    public partial class CustomerAddressesService : ICustomerAddressesService
    {
        ...
        /// <returns></returns>
        public CustomerAddressesService(VRPayment.Client.Configuration configuration)
        {
        ...
        public CustomerAddressesService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> DeleteCustomersCustomerIdAddressesIdWithHttpInfo(long customerId, long id, long space, int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<CustomerAddressListResponse> localVarResponse = GetCustomersCustomerIdAddressesWithHttpInfo(customerId, space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerAddressListResponse</returns>
        public VRPayment.Client.ApiResponse<CustomerAddressListResponse> GetCustomersCustomerIdAddressesWithHttpInfo(long customerId, long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<CustomerAddress> localVarResponse = GetCustomersCustomerIdAddressesIdWithHttpInfo(customerId, id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerAddress</returns>
        public VRPayment.Client.ApiResponse<CustomerAddress> GetCustomersCustomerIdAddressesIdWithHttpInfo(long customerId, long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<CustomerAddressSearchResponse> localVarResponse = GetCustomersCustomerIdAddressesSearchWithHttpInfo(customerId, space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerAddressSearchResponse</returns>
        public VRPayment.Client.ApiResponse<CustomerAddressSearchResponse> GetCustomersCustomerIdAddressesSearchWithHttpInfo(long customerId, long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<CustomerAddress> localVarResponse = PatchCustomersCustomerIdAddressesIdWithHttpInfo(customerId, id, space, customerAddressActive, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerAddress</returns>
        public VRPayment.Client.ApiResponse<CustomerAddress> PatchCustomersCustomerIdAddressesIdWithHttpInfo(long customerId, long id, long space, CustomerAddressActive customerAddressActive, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'customerAddressActive' is set
            if (customerAddressActive == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'customerAddressActive' when calling CustomerAddressesService->PatchCustomersCustomerIdAddressesId");
            }
        ...
        {
            VRPayment.Client.ApiResponse<CustomerAddress> localVarResponse = PostCustomersCustomerIdAddressesWithHttpInfo(customerId, space, customerAddressCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerAddress</returns>
        public VRPayment.Client.ApiResponse<CustomerAddress> PostCustomersCustomerIdAddressesWithHttpInfo(long customerId, long space, CustomerAddressCreate customerAddressCreate, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'customerAddressCreate' is set
            if (customerAddressCreate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'customerAddressCreate' when calling CustomerAddressesService->PostCustomersCustomerIdAddresses");
            }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> PostCustomersCustomerIdAddressesIdDefaultWithHttpInfo(long customerId, long id, long space, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
