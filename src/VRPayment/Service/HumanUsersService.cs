...
namespace VRPayment.Service
{
    ...
    public partial class HumanUsersService : IHumanUsersService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of HumanUserListResponse</returns>
        public VRPayment.Client.ApiResponse<HumanUserListResponse> GetHumanUsersWithHttpInfo(long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        public VRPayment.Client.ApiResponse<System.IO.Stream> GetHumanUsersExportWithHttpInfo(List<string>? fields = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of HumanUser</returns>
        public VRPayment.Client.ApiResponse<HumanUser> GetHumanUsersIdWithHttpInfo(long id, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of HumanUserSearchResponse</returns>
        public VRPayment.Client.ApiResponse<HumanUserSearchResponse> GetHumanUsersSearchWithHttpInfo(List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of HumanUser</returns>
        public VRPayment.Client.ApiResponse<HumanUser> PatchHumanUsersIdWithHttpInfo(long id, HumanUserUpdate humanUserUpdate, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of HumanUser</returns>
        public VRPayment.Client.ApiResponse<HumanUser> PostHumanUsersWithHttpInfo(HumanUserCreate humanUserCreate, List<string>? expand = default, int operationIndex = 0)
        {
