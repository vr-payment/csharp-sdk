...
namespace VRPayment.Service
{
    ...
    public partial class HumanUsersService : IHumanUsersService
    {
        ...
        /// <returns></returns>
        public HumanUsersService(VRPayment.Client.Configuration configuration)
        {
        ...
        public HumanUsersService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> DeleteHumanUsersIdWithHttpInfo(long id, int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<HumanUserListResponse> localVarResponse = GetHumanUsersWithHttpInfo(after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of HumanUserListResponse</returns>
        public VRPayment.Client.ApiResponse<HumanUserListResponse> GetHumanUsersWithHttpInfo(long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<System.IO.Stream> localVarResponse = GetHumanUsersExportWithHttpInfo(fields, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        public VRPayment.Client.ApiResponse<System.IO.Stream> GetHumanUsersExportWithHttpInfo(List<string>? fields = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<HumanUser> localVarResponse = GetHumanUsersIdWithHttpInfo(id, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of HumanUser</returns>
        public VRPayment.Client.ApiResponse<HumanUser> GetHumanUsersIdWithHttpInfo(long id, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<HumanUserSearchResponse> localVarResponse = GetHumanUsersSearchWithHttpInfo(expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of HumanUserSearchResponse</returns>
        public VRPayment.Client.ApiResponse<HumanUserSearchResponse> GetHumanUsersSearchWithHttpInfo(List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<HumanUser> localVarResponse = PatchHumanUsersIdWithHttpInfo(id, humanUserUpdate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of HumanUser</returns>
        public VRPayment.Client.ApiResponse<HumanUser> PatchHumanUsersIdWithHttpInfo(long id, HumanUserUpdate humanUserUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'humanUserUpdate' is set
            if (humanUserUpdate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'humanUserUpdate' when calling HumanUsersService->PatchHumanUsersId");
            }
        ...
        {
            VRPayment.Client.ApiResponse<HumanUser> localVarResponse = PostHumanUsersWithHttpInfo(humanUserCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of HumanUser</returns>
        public VRPayment.Client.ApiResponse<HumanUser> PostHumanUsersWithHttpInfo(HumanUserCreate humanUserCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'humanUserCreate' is set
            if (humanUserCreate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'humanUserCreate' when calling HumanUsersService->PostHumanUsers");
            }
