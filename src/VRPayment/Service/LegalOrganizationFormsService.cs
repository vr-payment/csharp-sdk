...
namespace VRPayment.Service
{
    ...
    public partial class LegalOrganizationFormsService : ILegalOrganizationFormsService
    {
        ...
        /// <returns></returns>
        public LegalOrganizationFormsService(VRPayment.Client.Configuration configuration)
        {
        ...
        public LegalOrganizationFormsService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        {
            VRPayment.Client.ApiResponse<LegalOrganizationFormListResponse> localVarResponse = GetLegalOrganizationFormsWithHttpInfo(after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LegalOrganizationFormListResponse</returns>
        public VRPayment.Client.ApiResponse<LegalOrganizationFormListResponse> GetLegalOrganizationFormsWithHttpInfo(long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<LegalOrganizationForm> localVarResponse = GetLegalOrganizationFormsIdWithHttpInfo(id, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LegalOrganizationForm</returns>
        public VRPayment.Client.ApiResponse<LegalOrganizationForm> GetLegalOrganizationFormsIdWithHttpInfo(long id, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<LegalOrganizationFormSearchResponse> localVarResponse = GetLegalOrganizationFormsSearchWithHttpInfo(expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LegalOrganizationFormSearchResponse</returns>
        public VRPayment.Client.ApiResponse<LegalOrganizationFormSearchResponse> GetLegalOrganizationFormsSearchWithHttpInfo(List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
