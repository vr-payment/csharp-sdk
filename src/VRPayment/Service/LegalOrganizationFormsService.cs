...
namespace VRPayment.Service
{
    ...
    public partial class LegalOrganizationFormsService : ILegalOrganizationFormsService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LegalOrganizationFormListResponse</returns>
        public VRPayment.Client.ApiResponse<LegalOrganizationFormListResponse> GetLegalOrganizationFormsWithHttpInfo(long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LegalOrganizationForm</returns>
        public VRPayment.Client.ApiResponse<LegalOrganizationForm> GetLegalOrganizationFormsIdWithHttpInfo(long id, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LegalOrganizationFormSearchResponse</returns>
        public VRPayment.Client.ApiResponse<LegalOrganizationFormSearchResponse> GetLegalOrganizationFormsSearchWithHttpInfo(List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
