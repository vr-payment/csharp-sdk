...
namespace VRPayment.Service
{
    ...
    public partial class SpacesService : ISpacesService
    {
        ...
        /// <returns></returns>
        public SpacesService(VRPayment.Client.Configuration configuration)
        {
        ...
        public SpacesService(VRPayment.Client.ISynchronousClient client, VRPayment.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public VRPayment.Client.ApiResponse<Object> DeleteSpacesIdWithHttpInfo(long id, int operationIndex = 0)
        {
        ...
        {
            VRPayment.Client.ApiResponse<SpaceListResponse> localVarResponse = GetSpacesWithHttpInfo(after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SpaceListResponse</returns>
        public VRPayment.Client.ApiResponse<SpaceListResponse> GetSpacesWithHttpInfo(long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<Space> localVarResponse = GetSpacesIdWithHttpInfo(id, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Space</returns>
        public VRPayment.Client.ApiResponse<Space> GetSpacesIdWithHttpInfo(long id, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<SpaceSearchResponse> localVarResponse = GetSpacesSearchWithHttpInfo(expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SpaceSearchResponse</returns>
        public VRPayment.Client.ApiResponse<SpaceSearchResponse> GetSpacesSearchWithHttpInfo(List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        {
            VRPayment.Client.ApiResponse<Space> localVarResponse = PatchSpacesIdWithHttpInfo(id, spaceUpdate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Space</returns>
        public VRPayment.Client.ApiResponse<Space> PatchSpacesIdWithHttpInfo(long id, SpaceUpdate spaceUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'spaceUpdate' is set
            if (spaceUpdate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'spaceUpdate' when calling SpacesService->PatchSpacesId");
            }
        ...
        {
            VRPayment.Client.ApiResponse<Space> localVarResponse = PostSpacesWithHttpInfo(spaceCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Space</returns>
        public VRPayment.Client.ApiResponse<Space> PostSpacesWithHttpInfo(SpaceCreate spaceCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'spaceCreate' is set
            if (spaceCreate == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'spaceCreate' when calling SpacesService->PostSpaces");
            }
