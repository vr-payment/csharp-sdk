...
namespace VRPayment.Service
{
    ...
    public partial class SpacesService : ISpacesService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SpaceListResponse</returns>
        public VRPayment.Client.ApiResponse<SpaceListResponse> GetSpacesWithHttpInfo(long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Space</returns>
        public VRPayment.Client.ApiResponse<Space> GetSpacesIdWithHttpInfo(long id, List<string>? expand = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SpaceSearchResponse</returns>
        public VRPayment.Client.ApiResponse<SpaceSearchResponse> GetSpacesSearchWithHttpInfo(List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            VRPayment.Client.RequestOptions localVarRequestOptions = new VRPayment.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Space</returns>
        public VRPayment.Client.ApiResponse<Space> PatchSpacesIdWithHttpInfo(long id, SpaceUpdate spaceUpdate, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Space</returns>
        public VRPayment.Client.ApiResponse<Space> PostSpacesWithHttpInfo(SpaceCreate spaceCreate, List<string>? expand = default, int operationIndex = 0)
        {
