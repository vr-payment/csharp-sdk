...
namespace VRPayment.Service
{
    ...
    public partial class PaymentWebAppsService : IPaymentWebAppsService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ChargeAttempt</returns>
        public VRPayment.Client.ApiResponse<ChargeAttempt> PatchPaymentWebAppsChargeAttemptsIdWithHttpInfo(long id, long space, PaymentAppChargeAttemptUpdate paymentAppChargeAttemptUpdate, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionCompletion</returns>
        public VRPayment.Client.ApiResponse<TransactionCompletion> PatchPaymentWebAppsCompletionsIdWithHttpInfo(long id, long space, PaymentAppCompletionUpdate paymentAppCompletionUpdate, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentAppConnector</returns>
        public VRPayment.Client.ApiResponse<PaymentAppConnector> PatchPaymentWebAppsConnectorsConnectorExternalIdWithHttpInfo(string connectorExternalId, long space, PaymentAppConnectorDetails paymentAppConnectorDetails, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'connectorExternalId' is set
            if (connectorExternalId == null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentAppProcessor</returns>
        public VRPayment.Client.ApiResponse<PaymentAppProcessor> PatchPaymentWebAppsProcessorsExternalIdWithHttpInfo(string externalId, long space, PaymentAppProcessorDetails paymentAppProcessorDetails, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'externalId' is set
            if (externalId == null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Refund</returns>
        public VRPayment.Client.ApiResponse<Refund> PatchPaymentWebAppsRefundsIdWithHttpInfo(long id, long space, PaymentAppRefundUpdate paymentAppRefundUpdate, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionVoid</returns>
        public VRPayment.Client.ApiResponse<TransactionVoid> PatchPaymentWebAppsVoidsIdWithHttpInfo(long id, long space, PaymentAppVoidUpdate paymentAppVoidUpdate, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentAppProcessor</returns>
        public VRPayment.Client.ApiResponse<PaymentAppProcessor> PostPaymentWebAppsProcessorsWithHttpInfo(long space, PaymentAppProcessorDetailsCreate paymentAppProcessorDetailsCreate, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentAppProcessor</returns>
        public VRPayment.Client.ApiResponse<PaymentAppProcessor> PostPaymentWebAppsProcessorsExternalIdActivateForProductionWithHttpInfo(string externalId, long space, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'externalId' is set
            if (externalId == null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentAppConnector</returns>
        public VRPayment.Client.ApiResponse<PaymentAppConnector> PostPaymentWebAppsProcessorsExternalIdConnectorsWithHttpInfo(string externalId, long space, PaymentAppConnectorDetailsCreate paymentAppConnectorDetailsCreate, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'externalId' is set
            if (externalId == null)
            {
