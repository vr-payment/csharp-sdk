...
namespace VRPayment.Service
{
    ...
    public partial class ExpressCheckoutService : IExpressCheckoutService
    {
        ...
        {
            VRPayment.Client.ApiResponse<ExpressCheckoutShippingAddressChangeResponse> localVarResponse = PatchExpressCheckoutShippingAddressChangeWithHttpInfo(sessionToken, space, expressCheckoutShippingAddressChangeRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ExpressCheckoutShippingAddressChangeResponse</returns>
        public VRPayment.Client.ApiResponse<ExpressCheckoutShippingAddressChangeResponse> PatchExpressCheckoutShippingAddressChangeWithHttpInfo(string sessionToken, long space, ExpressCheckoutShippingAddressChangeRequest expressCheckoutShippingAddressChangeRequest, int operationIndex = 0)
        {
            // verify the required parameter 'sessionToken' is set
            if (sessionToken == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'sessionToken' when calling ExpressCheckoutService->PatchExpressCheckoutShippingAddressChange");
            }
            ...
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'expressCheckoutShippingAddressChangeRequest' when calling ExpressCheckoutService->PatchExpressCheckoutShippingAddressChange");
            }
            ...
            localVarRequestOptions.QueryParameters.Add(VRPayment.Client.ClientUtils.ParameterToMultiMap("", "sessionToken", sessionToken));
        ...
        {
            VRPayment.Client.ApiResponse<ExpressCheckoutShippingMethodChangeResponse> localVarResponse = PatchExpressCheckoutShippingMethodChangeWithHttpInfo(sessionToken, space, expressCheckoutShippingMethodChangeRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ExpressCheckoutShippingMethodChangeResponse</returns>
        public VRPayment.Client.ApiResponse<ExpressCheckoutShippingMethodChangeResponse> PatchExpressCheckoutShippingMethodChangeWithHttpInfo(string sessionToken, long space, ExpressCheckoutShippingMethodChangeRequest expressCheckoutShippingMethodChangeRequest, int operationIndex = 0)
        {
            // verify the required parameter 'sessionToken' is set
            if (sessionToken == null)
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'sessionToken' when calling ExpressCheckoutService->PatchExpressCheckoutShippingMethodChange");
            }
            ...
            {
                throw new VRPayment.Client.ApiException(400, "Missing required parameter 'expressCheckoutShippingMethodChangeRequest' when calling ExpressCheckoutService->PatchExpressCheckoutShippingMethodChange");
            }
