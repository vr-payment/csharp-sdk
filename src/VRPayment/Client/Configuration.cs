...
namespace VRPayment.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration(long applicationUserId, string authenticationKey)
        {
            ...
            BasePath = "https://gateway.vr-payment.de/api/v2.0";
        ...
        public Configuration(
            ...
            string basePath = "https://gateway.vr-payment.de/api/v2.0") : this(applicationUserId, authenticationKey)
        {
